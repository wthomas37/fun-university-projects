...
/* package hip-barcodes-0.1.0.0 */
#ifndef VERSION_hip_barcodes
#define VERSION_hip_barcodes "0.1.0.0"
#endif /* VERSION_hip_barcodes */
#ifndef MIN_VERSION_hip_barcodes
#define MIN_VERSION_hip_barcodes(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hip_barcodes */
...
#define CURRENT_COMPONENT_ID "hip-barcodes-0.1.0.0-inplace-hip-barcodes"
