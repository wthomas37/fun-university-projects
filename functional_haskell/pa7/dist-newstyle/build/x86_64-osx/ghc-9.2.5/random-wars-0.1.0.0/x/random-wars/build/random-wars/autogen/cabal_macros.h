...
/* package random-wars-0.1.0.0 */
#ifndef VERSION_random_wars
#define VERSION_random_wars "0.1.0.0"
#endif /* VERSION_random_wars */
#ifndef MIN_VERSION_random_wars
#define MIN_VERSION_random_wars(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_random_wars */
...
#define CURRENT_COMPONENT_ID "random-wars-0.1.0.0-inplace-random-wars"
